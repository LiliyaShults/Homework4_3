...
public class TestWithLogin {
    WebDriver driver;
    private Logger logger = LogManager.getLogger(TestWithLogin.class);
    ...
    public void testLogin() {
        ...
        elEmail.sendKeys("shulczvick@yandex.ru");
        ...
        elPassword.sendKeys("Qwerty1234!");
        ...
        String present;
        try {
            driver.findElement(By.className("//*[@id=\"__next\"]/div[1]/div[1]/div/section/div[2]/span"));
        ...
        WebElement elExit = driver.findElement(By.xpath("//*[@id=\"__next\"]/div[1]/div[1]/div/section/div[2]/div[3]/button"));
        elExit.click();
